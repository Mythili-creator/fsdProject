...
export class CompanyEditComponent implements OnInit {
 ...
 editForm: FormGroup;
  ...
  ngOnInit() {
    ...
    this.stockService.getCompany(mid).subscribe(data => {
      ...
      companyCode: new FormControl(this.company.companyCode, [Validators.required]),
 ...
 boardOfDirectors : new FormControl(this.company.boardOfDirectors, [
      ...
      this.editForm
      .get("companyCode")
      .valueChanges.subscribe(value => (this.company.companyCode = value));
  ...
  get companyCode() {
    return this.editForm.get("companyCode");
  }
   get turnOver() {
